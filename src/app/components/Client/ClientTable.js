...
class ClientTable extends Component {
      ...
      return (
        <div>
          ...
          <Paper className={classes.root}>
            <CrudTable
              dataInit={content}
              anchor={clientConst.table.columns}
              title={clientConst.table.title}
              dataTable={content}
              fetchData={fetchData}
  ...
  const ClientTableMapped = connect(
    mapStateToProps,
    mapDispatchToProps
  )(ClientTable);
  
  export default withStyles(styles)(ClientTableMapped);