    ...
    routes: [
      {
        ...
        routes: [
          ...
          {
            path: '/admin/layouts/grid',
            component: withTracker(Grid),
          },
          {
            path: '/admin/layouts/app-layout',
            component: withTracker(AppLayout),
          },
          {
            path: '/admin/layouts/responsive',
          ...
          {
            path: '/admin/tables/tree-table',
            component: withTracker(TreeTable),
          },
          {
            path: '/admin/tables/crud-table',
